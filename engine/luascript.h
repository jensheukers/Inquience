...
public:
	...
	*/
	std::string RunFunction(std::string file , std::string function, std::vector<std::string> arguments = std::vector<std::string>());
	...
	*/
	void AddNativeFunction(std::string name, int(*func)(lua_State*) );
	...
	*/
	int GetType(std::string variableName);
	...
	*/
	int GetNumber(std::string variableName);
